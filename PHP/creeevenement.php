...
<section id="section_profil">
    ...
    <form method="post" class="form-horizontal" action="evenement.php" enctype="multipart/form-data">
        <div class="form-group">
            <label style="width:200px;" class="col-sm-2 control-label" for="nomevenement">
				Nom de l'évènement* :
            </label>
            <div class="col-sm-10" style="float:none;"> 
				<input type="text" class="form-control" style="width:200px;"  name="nomevenement" placeholder= "Nom de l'évènement" />  
            </div>
        </div>
        <div class="form-group">
            ...
            <div style="float:none;" class="col-sm-10"> 
				<input type="date" class="form-control" style="width:200px;"  name="date" placeholder= "aaaa-mm--jj" />  
            </div>
        </div>
        <div class="form-group">
            ...
            <div style="float:none;" class="col-sm-10"> 
				<input type="time" class="form-control" style="width:200px;"  name="heure" placeholder= "HH:MM" />  
            </div>
        </div>
        <div class="form-group">
            ...
            <div style="float:none;" class="col-sm-10"> 
				<input type="text" class="form-control" style="width:200px;"  name="lieu" placeholder= "Lieu de l'évènement" />  
            </div>
        </div>
        <div>
