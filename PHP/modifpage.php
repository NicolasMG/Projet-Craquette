...
<section id="section_profil">
    ...
    <form class="form-horizontal" method="post" action="traitementmodifpage.php?nom=<?php echo $nom;?>" enctype="multipart/form-data">
        <div class="form-group">
            <label style="padding-left:0;width:200px;" class="col-sm-2 control-label" for="nom">Nom de la page :</label>           
            <div  class="col-sm-10" style="display:inline;float:none;">
                <input class="form-control" style="width:200px; display:inline;" type="text" name="nom" placeholder="Nom de la page" />
            </div>
        </div>
